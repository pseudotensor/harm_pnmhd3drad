// compile using:
// gcc -Wall -lm -O3 -o perftest perftest.c
...
#define NUMCPUS 1 // >1 assumes USEMPICH and USEGM are set appropriately already
...
#define NUMTRIALSX 2 // number of runs to do in each direction
#define STARTNX 4 // what grid size to start at
#define ENDNX  6 // what grid size to end at
#if(NUMTRIALSX<=1)
