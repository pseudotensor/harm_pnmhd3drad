...
#if(!INNERBC)
	if( ((i>=0)&&(i<N1))&&((j>=0)&&(j<N2))&&((k>=0)&&(k<N3)) ) i=N1; // skip known non-boundary zones-3d version
#endif
...
#include "boundpos.h"
	...
	if(
	  ...
	  fprintf(fail_file,"s[%d]: k=%d,j=%d,i=%d quad: undefined boundary bi: %d bj: %d\n",ll,k,j,i,bi,bj);
	  myexit(1);
	}
	else if(
		(bi==99)||(bj==99)
	  ...
	  //  i-reflect(or AOS) AND j/k-inflow/outflow/periodic/reflect(or AOS)
	    ...
	    fprintf(fail_file,"s[%d]: k=%d j=%d,i=%d quad: No boundary case setup for bi: %d bj: %d\n",ll,k,j,i,bi,bj);
	    myexit(1);
	  }
	...
	if(
	   (bis[1][0])||(bis[2][0])||(bis[3][0])
	   ){
	  fprintf(fail_file,"s[%d]: k=%d,j=%d,i=%d quad: undefined boundary bi: %d bj: %d bk: %d\n",ll,k,j,i,bi,bj,bk);
	  myexit(1);
	}
	else if(
		(bis[1][99])||(bis[2][99])||(bis[3][99])
		){
	  // do nothing
	}
	else{ // if good corner
	  ...
	  if(// i-inflow AND j-inflow or if p-i or i-p 
	     ((bis[1][3])&&(bis[2][3])||(bis[2][5]))&&((bijk[3]&&(bk==3))||(bijk[3]&&(bk==5))))||
	     ((!bijk[2]||(bj==3))&&((bijk[1]&&(bi==3))||(bijk[1]&&(bi==5)))&&((bijk[3]&&(bk==3))||(bijk[3]&&(bk==5))))||
	     ((!bijk[3]||(bk==3))&&((bijk[2]&&(bj==3))||(bijk[2]&&(bj==5)))&&((bijk[1]&&(bi==3))||(bijk[1]&&(bi==5))))
	     ){
	  ...
	  // i-periodic AND j-periodic
		  ...
		  (bijk[1]&&(bi==5))&&(bijk[2]&&(bj==5))&&(bijk[3]&&(bk==5))
		  ){
	  ...
	  // i/k-outflow/inflow/periodic AND j-outflow (if o-o, same effect as next case)
		  ...
		  (((bijk[1]&&(bi==4))||(bijk[1]&&(bi==3))||(bijk[1]&&(bi==5)))&&(bijk[2]&&(bj==4)))&&
		  (((bijk[3]&&(bk==4))||(bijk[3]&&(bk==3))||(bijk[3]&&(bk==5)))&&(bijk[2]&&(bj==4)))
		  ){
	    typeofbc=3;
	  }
	  // j/k-outflow/inflow/periodic AND i-outflow
	  else if(
		  (((bijk[2]&&(bj==4))||(bijk[2]&&(bj==3))||(bijk[2]&&(bj==5)))&&(bijk[1]&&(bi==4)))&&
		  (((bijk[3]&&(bk==4))||(bijk[3]&&(bk==3))||(bijk[3]&&(bk==5)))&&(bijk[1]&&(bi==4)))
		  ){
	  ...
	  // j/i-outflow/inflow/periodic AND k-outflow
		  ...
		  (((bijk[2]&&(bj==4))||(bijk[2]&&(bj==3))||(bijk[2]&&(bj==5)))&&(bijk[3]&&(bk==4)))&&
		  (((bijk[1]&&(bi==4))||(bijk[1]&&(bi==3))||(bijk[1]&&(bi==5)))&&(bijk[3]&&(bk==4)))
		  ){
	  ...
	  // i/k-inflow/outflow/periodic/reflect(or AOS) AND j-reflect(or AOS)
		  ...
		  (((bijk[1]&&(bi==3))||(bijk[1]&&(bi==4))||(bijk[1]&&(bi==5))||(bijk[1]&&(bi==1))||(bijk[1]&&(bi==2)))&& ((bijk[2]&&(bj==1))||(bijk[2]&&(bj==2))) )&&
		  (((bijk[3]&&(bk==3))||(bijk[3]&&(bk==4))||(bijk[3]&&(bk==5))||(bijk[3]&&(bk==1))||(bijk[3]&&(bk==2)))&& ((bijk[2]&&(bj==1))||(bijk[2]&&(bj==2))) )
		  ){
	  ...
	  //  i-reflect(or AOS) AND j/k-inflow/outflow/periodic/reflect(or AOS)
		  ...
		  (((bijk[2]&&(bj==3))||(bijk[2]&&(bj==4))||(bijk[2]&&(bj==5))||(bijk[2]&&(bj==1))||(bijk[2]&&(bj==2)))&& ((bijk[1]&&(bi==1))||(bijk[1]&&(bi==2))) )&&
		  (((bijk[3]&&(bk==3))||(bijk[3]&&(bk==4))||(bijk[3]&&(bk==5))||(bijk[3]&&(bk==1))||(bijk[3]&&(bk==2)))&& ((bijk[1]&&(bi==1))||(bijk[1]&&(bi==2))) )
		  ){
	  ...
	  //  k-reflect(or AOS) AND j/i-inflow/outflow/periodic/reflect(or AOS)
		  ...
		  (((bijk[2]&&(bj==3))||(bijk[2]&&(bj==4))||(bijk[2]&&(bj==5))||(bijk[2]&&(bj==1))||(bijk[2]&&(bj==2)))&& ((bijk[3]&&(bk==1))||(bijk[3]&&(bk==2))) )&&
		  (((bijk[1]&&(bi==3))||(bijk[1]&&(bi==4))||(bijk[1]&&(bi==5))||(bijk[1]&&(bi==1))||(bijk[1]&&(bi==2)))&& ((bijk[3]&&(bk==1))||(bijk[3]&&(bk==2))) )
		  ){
	    
	    typeofbc=8;
	  }
	  else{
	    fprintf(fail_file,"s[%d]: k=%d j=%d,i=%d quad: No boundary case setup for bi: %d bj: %d bk: %d\n",ll,k,j,i,bi,bj,bk);
	    myexit(1);
	  }
...
#include "boundpos.h"
	...
	if(
	  ...
	  if(0&&(wbound==2)){
		...
		if((typeofbc==3)||(typeofbc==6)||(typeofbc==7)||(typeofbc==10)||(typeofbc==5)||(typeofbc==9)||(typeofbc==4)||(typeofbc==8)){
		  ...
		  fprintf(fail_file,"v[%d]: k=%d j=%d,i=%d quad: No boundary case setup for bi: %d bj: %d bk: %d\n",ll,k,j,i,bi,bj,bk);
		  myexit(1);
		}
		// update position to next zone over
		ii+=loopi;
	...
	bi=bcv[wbound][1][k+gk[corner]][j+gj[corner]][i]; // i-boundary type
	bj=bcv[wbound][1][k+gk[corner]][j][i+gi[corner]]; // j-boundary type
	bk=bcv[wbound][1][k][j+gj[corner]][i+gi[corner]]; // k-boundary type
	...
	if(
	  ...
	  fprintf(fail_file,"v[%d]: k=%d,j=%d,i=%d quad: undefined boundary bi: %d bj: %d bk: %d\n",ll,k,j,i,bi,bj,bk);
	  myexit(1);
	}
	else if(
#if(COMPDIM<3)
	  ...
	  for(p=0;p<numcornerzones;p++){
	    ...
	    if((ii==-1)&&(jj==-1)&&(ll==2)){
	      fprintf(stdout,"%d %d %d  %d %d %d\n",kk,jj,ii,kkk,jjj,iii); fflush(stdout);
	    }
