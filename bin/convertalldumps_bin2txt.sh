...
#
./bin2txt 1 2 0 0 3 $1 $2 $3 1 $fnamebin $fnametxt d 39
cat $fnamebin.head $fnametxt > $fnamedat
rm -rf $fnametxt

done

./bin2txt 1 2 0 0 3 $1 $2 $3 1 0_gridact1.par.bin 0_gridact1.par.txt d 36
./bin2txt 1 2 0 0 3 $1 $2 $3 1 0_gridact2.par.bin 0_gridact2.par.txt d 36
